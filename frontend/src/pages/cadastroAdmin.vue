          ...
          <form @submit.prevent="cadastrarAdmin">
            ...
            <div class="grid-2">
              ...
              <div class="field">
                ...
                <div class="input-wrapper">
                  <input v-model="confirmarSenha" :type="mostrarConfirmarSenha ? 'text' : 'password'" required>
